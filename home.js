  ...
  function goToSlide(index) {
    slidess[current].classList.remove('active');
    dots[current].classList.remove('active');
    current = index;
    slidess[current].classList.add('active');
    dots[current].classList.add('active');
    resetTimerHome();
  }

  function nextSlide() {
    goToSlide((current + 1) % slidess.length);
  }

  function resetTimerHome() {
    clearInterval(timer);
